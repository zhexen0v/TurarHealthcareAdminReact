...
import './addOrUpdateDocumentCategoryForm.scss';

const AddOrUpdateDocumentCategoryForm = ({obj, toggle, handleFunction, isUpdating}) => {
...
export default AddOrUpdateDocumentCategoryForm;